...
def main(N=128,Nfinal=2000,dt=0.1,ckeep=20,L=50.,num_of_datasets=100): 
    ...
    for m in range(1,num_of_datasets+1):
        ...
        out.create_dataset('r',r[:,0].shape,dtype='float')
        out['r'][...] = r[:,0]
        ...
        for n in range(1,Nfinal+1):
            ...
            if n % ckeep == 0:
                ...
                out['ukeep'][:,:,n//ckeep] = u
                out.close()
        print('ddd_gen_data_v2.py output:  ' + outName)
